...
public class DigitSplitter {
	...
	/**
	 * 입력한 수와 그 수의 자릿수를 받아서 
	 * 한글자씩 출력함
	 * @param room 자릿수
	 * @param m 입력한 수
	 */
	public static void splitter(int room,int m) {
		...
		int temp =m;
		for(i=0;i<room;i++) {
			System.out.print(temp/powerOfTen(room-i));
			System.out.print(" ");
			temp = m%powerOfTen(room-i);
		}
